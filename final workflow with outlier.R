...
cor.lcl <- cor(abatch_lcl,method="pearson", use="complete.obs")
heatmap.2(cor.lcl, Rowv=rhc,
          Colv=rhc, margins=c(5,9),key=T, revC=T, density.info="histogram", trace="none", dendrogram = "column")
